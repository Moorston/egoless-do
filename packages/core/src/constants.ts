...
export function buildExerciseLibrary(): ExerciseDef[] {
  ...
  const strengthExtensions: ExerciseDef[] = [
    { id: 'ex_bench_press', nameZh: '杠铃卧推', nameI18nKey: '', icon: '🏋️', category: 'chest_triceps', type: 'strength', muscleGroups: ['胸大肌', '三角肌前束', '肱三头肌'], equipment: '杠铃、卧推凳', difficulty: 'intermediate', defaultSets: 4, defaultReps: 10, defaultWeight: 40, defaultRestSec: 90, met: 8, description: '仰卧于卧推凳，握距略宽于肩。杠铃下放至胸部中段，肘关节约90度。发力推起至手臂伸直。核心收紧，臀部不离凳。' },
    ...
    { id: 'ex_barbell_row', nameZh: '杠铃划船', nameI18nKey: '', icon: '🏋️', category: 'back_biceps', type: 'strength', muscleGroups: ['背阔肌', '斜方肌', '肱二头肌'], equipment: '杠铃', difficulty: 'intermediate', defaultSets: 4, defaultReps: 10, defaultWeight: 40, defaultRestSec: 90, met: 7, description: '俯身约45度，双手正握杠铃。收紧核心，将杠铃拉向下腹部。感受背部肌肉收缩，顶峰挤压肩胛骨。缓慢下放，保持背部挺直。' },
    { id: 'ex_pullup', nameZh: '引体向上', nameI18nKey: '', icon: '🤸', category: 'back_biceps', type: 'strength', muscleGroups: ['背阔肌', '肱二头肌', '核心'], equipment: '单杠', difficulty: 'advanced', defaultSets: 4, defaultReps: 8, defaultRestSec: 90, met: 8, description: '双手正握单杠，握距略宽于肩。收紧核心，发力拉起至下巴过杠。顶峰挤压背部，缓慢下放至手臂伸直。避免摆动身体借力。' },
    ...
    { id: 'ex_squat', nameZh: '杠铃深蹲', nameI18nKey: '', icon: '🦵', category: 'legs_core', type: 'strength', muscleGroups: ['股四头肌', '臀大肌', '核心', '腘绳肌'], equipment: '杠铃、深蹲架', difficulty: 'intermediate', defaultSets: 4, defaultReps: 10, defaultWeight: 50, defaultRestSec: 120, met: 8, description: '杠铃置于上背部，双脚略宽于肩。屈髋屈膝下蹲至大腿平行地面。膝盖方向与脚尖一致。发力站起，核心全程收紧。' },
    { id: 'ex_deadlift', nameZh: '硬拉', nameI18nKey: '', icon: '🏋️', category: 'legs_core', type: 'strength', muscleGroups: ['背部', '臀大肌', '腘绳肌', '核心'], equipment: '杠铃', difficulty: 'advanced', defaultSets: 3, defaultReps: 8, defaultWeight: 60, defaultRestSec: 120, met: 9, description: '双脚与肩同宽站立，屈髋屈膝握住杠铃。背部挺直，发力站起至身体伸直。核心收紧，杠铃贴身。缓慢下放，保持脊柱中立。' },
