export interface I18nKeys {
  ...
  sleepBedtimeWake: string; sleepBedtimeShort: string; sleepWakeShort: string;
  sleepNote: string; sleepNotePlaceholder: string;
  sleepHowWasSleep: string; sleepAddMore: string;
  sleepTodayNote: string; sleepTodayNotePlaceholder: string;
  sleepPracticeRecord: string; sleepStreakDays: string; sleepDayUnit: string;
  sleepBackToHome: string; sleepTotalSleep: string; sleepTotalDays: string;
  sleepAvgDuration: string; sleepAvgQuality: string;
  sleepWeekAvgTime: string; sleepMonthAvgTime: string;
  sleepHeatmapTitle: string; sleepWeekdayPrefix: string;
  sleepBarrierDone: string; sleepBarrierNotDone: string;
  sleepGratitudeItems: string; sleepInsightNote: string;
  sleepWriteInsight: string; sleepNoNotes: string;
  sleepDeleteRecord: string; sleepDeleteRecordConfirm: string;
  sleepHistoryTitle: string; sleepNoRecords: string;
  sleepEmptySubtitle: string; sleepEmptySubtitle2: string; sleepStartRecording: string;
  sleepBreath: string; sleepMeditate: string; sleepReading: string; sleepJournal: string;
  sleepGratitudeSmall: string; sleepGratitudeCount: string;
  sleepRitualEntrance: string; sleepWeekTrend: string; sleepAverage: string;
  sleepStreakRecord: string; sleepAutoCalculate: string; sleepAdvancedSettings: string;
  sleepWeekendGoalOptional: string; sleepWeekendBedtime: string; sleepWeekendWake: string;
  sleepNotSet: string; sleepReminderStages: string; sleepMinutesBefore: string;
  sleepChooseMantra: string; sleepChooseReading: string;
  sleepSaved: string; sleepGoalAchieved: string; sleepMore: string; sleepLess: string;
  sleepRecord: string; sleepFullDiary: string; sleepTapToRate: string;
  sleepLast7Days: string; sleepRecordLastNight: string; sleepQuickRecordTip: string;
  sleepTargetBedtime: string; sleepOrganActive: string; sleepAutoRecordAfter: string;
  sleepStartRitual: string; sleepSnoozeIn10Min: string; sleepRemindLater: string;
  sleepRemaining: string; sleepTimes: string;
  sleepSkipTonight: string; sleepSkipTonightConfirm: string;
  sleepQualityExcellent: string; sleepQualityGood: string; sleepQualityAverage: string;
  sleepQualityPoor: string; sleepQualityBad: string;
  sleepTimePickerHint: string; sleepYearUnit: string; sleepMonthUnit: string;
  sleepTwelvePeriods: string; sleepDistance: string;
  sleepCurrentStar: string; sleepSetStar: string; sleepTapToSaveQuality: string;
  sleepTapToSaveWorkState: string; sleepOpenFullDiary: string;
  sleepEmptyTapToRecord: string; sleepAutoRecordCountdown: string;
