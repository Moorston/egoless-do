...
export const zh: I18nKeys = {
  ...
  preceptTitle:'持戒清净', preceptQuote:'持戒清净，禅定现前', preceptStreak:'连续', preceptTotalDays:'累计', preceptMonthRate:'本月完成率',
  ...
  // Mind (调心)
  mindTitle:'调心', mindTabFear:'恐惧图谱', mindTabCourage:'勇气行动', mindTabInsight:'洞察分析',
  ...
  // Sutra (诵经)
  sutraTitle:'诵经', sutraTabLibrary:'经文库', sutraTabCounter:'念诵计数', sutraTabStats:'统计',
  ...
  sutraCategoryDharani:'咒语', sutraCategorySutra:'经文', sutraCategoryCustom:'自定义',
  ...
  // ── 调身 Body ──
  bodyTitle:'调身', bodyProfile:'身体档案', bodyGoal:'调身目标', bodyPlan:'调身方案', bodyExec:'本周执行情况',
  bodyHeight:'身高', bodyWeight:'体重', bodyBmi:'BMI', bodyBodyFat:'体脂', bodyAge:'年龄', bodyGender:'性别',
  ...
  vowDeadline:'截止日期', vowTimeFrame:'时间框架',
  vowTf3Months:'3个月', vowTf6Months:'半年', vowTf1Year:'1年', vowTf3Years:'3年', vowTf5Years:'5年',
