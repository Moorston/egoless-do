...
export const zhHant: I18nKeys = {
  ...
  checkinSit:'早睡', checkinStand:'早起', checkinSutra:'冥想',
  ...
  checkinFreq:'打卡频率', freqDaily:'每天', freqInterval:'間隔', freqWeekly:'每週', freqWeeklyFixed:'每週固定', freqMonthly:'每月', freqMonthlyFixed:'每月固定',
